...
export declare enum CodeRequiredReason {
    TWO_FACTOR = "two_factor",
    CHECKPOINT = "checkpoint"
}
export declare enum MessageDeletionMode {
...
export declare const MessageAttachmentType: typeof AttachmentType;
...
export declare enum MessageBehavior {
