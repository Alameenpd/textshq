...
export type ThreadTitleUpdatedAction = {
    type: MessageActionType.THREAD_TITLE_UPDATED;
    title: string;
    actorParticipantID: UserID;
};
export type ThreadParticipantsAddedAction = {
    type: MessageActionType.THREAD_PARTICIPANTS_ADDED;
    participantIDs: UserID[];
    actorParticipantID: UserID;
    participants?: Participant[];
};
export type ThreadParticipantsRemovedAction = {
    type: MessageActionType.THREAD_PARTICIPANTS_REMOVED;
    participantIDs: UserID[];
    actorParticipantID: UserID;
    participants?: Participant[];
};
export type GroupThreadCreatedAction = {
    type: MessageActionType.GROUP_THREAD_CREATED;
    title: string;
    actorParticipantID: UserID;
};
export type ThreadImgChangedAction = {
    type: MessageActionType.THREAD_IMG_CHANGED;
    actorParticipantID: UserID;
};
export type MessageRequestAcceptedAction = {
    type: MessageActionType.MESSAGE_REQUEST_ACCEPTED;
};
export type MessageReactionCreatedAction = {
    type: MessageActionType.MESSAGE_REACTION_CREATED;
    messageID?: MessageID;
} & Partial<MessageReaction>;
export type MessageReactionDeletedAction = {
    type: MessageActionType.MESSAGE_REACTION_DELETED;
    messageID?: MessageID;
} & Partial<MessageReaction>;
export type MessageAction = ThreadTitleUpdatedAction | ThreadParticipantsAddedAction | ThreadParticipantsRemovedAction | GroupThreadCreatedAction | ThreadImgChangedAction | MessageRequestAcceptedAction | MessageReactionCreatedAction | MessageReactionDeletedAction;
export type MessageSeen = boolean | Date | // for single threads
{
