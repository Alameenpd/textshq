...
export type ServerEvent = StateSyncEvent | ThreadMessagesRefreshEvent | SessionUpdatedEvent | RefreshAccountEvent | ToastEvent | UserActivityEvent | UserPresenceEvent;
export {};
